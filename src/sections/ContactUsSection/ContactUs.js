...
const ContactUs = () => {
	...
	return (
		<section className="py-20 px-3 md:px-0" id="contact">
			<div className="container">
				...
				>
					<div class="container">
						<div class="mb-5 flex items-center max-w-md"></div>
						<div class="flex flex-col lg:flex-row lg:items-center text-slate-900 dark:text-gray-200 lg:justify-between -mx-4">
							<div
								...
								data-aos-delay="200"
							>
								<div class="max-w-[570px] mb-12 lg:mb-0 hidden md:block">
                                    ...
                                    "
										...
										<div class="mb-6">
											<textarea
												...
												class="textarea textarea-success resize-none w-full
                                    "
												name="message"
												id="message"
											></textarea>
